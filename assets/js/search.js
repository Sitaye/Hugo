  ...
  if (results.length > 0) {
    results.forEach(function (value, key) {
      ...
      resultsHTML =
        resultsHTML +
        `<li class="mb-2">
          <a class="search-bg-color flex items-center px-3 py-2 rounded-md appearance-none bg-neutral-100 dark:bg-neutral-700 focus:bg-primary-100 hover:bg-primary-100 dark:hover:bg-primary-900 dark:focus:bg-primary-900 focus:outline-dotted focus:outline-transparent focus:outline-2" 
